...
EVAL_QUESTIONS = [
    ...
    {
        "id": "kap_004",
        "question": "KCHOL yönetim kurulu son dönemde temettü dağıtım kararı aldı mı?",
        "question_en": "Did the KCHOL board of directors recently decide to distribute dividends?",
        "ticker": "KCHOL",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["temettü", "dağıtım", "yönetim kurulu", "karar"],
        "ground_truth": "KAP'ta yayınlanan KCHOL kar dağıtım/temettü açıklamalarına bakılarak yanıtlanır.",
    },
    {
        "id": "kap_005",
        "question": "BIMAS 2023 son çeyrek net kârı nedir?",
        "question_en": "What was BIMAS's net profit in the last quarter of 2023?",
        "ticker": "BIMAS",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["net", "kâr", "çeyrek", "finansal"],
        "ground_truth": "BIMAS finansal tablolarında belirtilen net dönem kârı incelenir.",
    },
    {
        "id": "kap_006",
        "question": "TUPRS tarafından KAP'a bildirilen son yatırım teşvik belgesi hakkında bilgi nedir?",
        "question_en": "What is the information regarding the latest investment incentive certificate reported by TUPRS to KAP?",
        "ticker": "TUPRS",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["yatırım", "teşvik", "belge", "kap", "TÜPRAŞ"],
        "ground_truth": "TÜPRAŞ'ın yatırım teşviklerine yönelik özel durum açıklamaları değerlendirilir.",
    },
    {
        "id": "kap_007",
        "question": "SISE yönetim kurulu sermaye artırımı kararı açıkladı mı?",
        "question_en": "Has the SISE board of directors announced a capital increase decision?",
        "ticker": "SISE",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["sermaye", "artırım", "yönetim", "bedelli", "bedelsiz"],
        "ground_truth": "Şişecam'ın sermaye artırımı kapsamındaki açıklamaları taranır.",
    },
    {
        "id": "kap_008",
        "question": "PGSUS'un KAP'a yaptığı son aylık trafik verileri bildiriminde yolcu sayısı arttı mı?",
        "question_en": "Did passenger numbers increase in PGSUS's latest monthly traffic data disclosure to KAP?",
        "ticker": "PGSUS",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["trafik", "yolcu", "veri", "artış"],
        "ground_truth": "Pegasus'un aylık trafik verilerine dair KAP açıklaması sonuçları raporlanır.",
    },
    {
        "id": "kap_009",
        "question": "EREGL son genel kurul toplantısında hangi gündem maddelerini onayladı?",
        "question_en": "What agenda items did EREGL approve in its last general assembly meeting?",
        "ticker": "EREGL",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["genel kurul", "gündem", "onay", "toplantı"],
        "ground_truth": "Erdemir'in olağan/olağanüstü genel kurul sonuç bildirimleri taranır.",
    },
    {
        "id": "kap_010",
        "question": "AKBNK yeni bir tahvil veya bono ihracı için SPK'ya başvuru yaptığını duyurdu mu?",
        "question_en": "Did AKBNK announce an application to the CMB for a new bond or bill issuance?",
        "ticker": "AKBNK",
        "category": "kap_centric",
        "expected_sources": ["kap"],
        "expected_keywords": ["tahvil", "bono", "ihraç", "SPK", "başvuru"],
        "ground_truth": "Akbank'ın borçlanma araçları ihraç belgesi onayına ilişkin açıklamaları incelenir.",
    },
